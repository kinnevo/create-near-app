...
})({"elsjo":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "65f58e8009af489e";
...
},{}],"ipbJo":[function(require,module,exports) {
var _runtime = require("regenerator-runtime/runtime");
var _utils = require("./near/utils");
...
document.querySelector("form").onsubmit = async (event)=>{
    ...
    try {
        await (0, _utils.set_greeting)(greeting.value);
    } catch (e) {
...
document.querySelector("#sign-in-button").onclick = (0, _utils.login);
document.querySelector("#sign-out-button").onclick = (0, _utils.logout);
async function fetchGreeting() {
    // Get greeting from the contract
    const currentGreeting = await (0, _utils.get_greeting)();
...
window.nearInitPromise = (0, _utils.initContract)().then(flow).catch(console.error);
function flow() {
...
},{"regenerator-runtime/runtime":"dXNgZ","./near/utils":"8ftwS"}],"dXNgZ":[function(require,module,exports) {
/**
...
},{}],"8ftwS":[function(require,module,exports) {
...
parcelHelpers.export(exports, "set_greeting", ()=>set_greeting);
parcelHelpers.export(exports, "get_greeting", ()=>get_greeting);
...
async function set_greeting(message) {
...
},{"near-api-js":"ohc3m","./config":"bZD2N","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ohc3m":[function(require,module,exports) {
"use strict";
...
},{"buffer":"fCgem","bn.js":"1L0Re","bs58":"4ji3p","text-encoding-utf-8":"feCA6"}],"fCgem":[function(require,module,exports) {
/*!
...
},{}],"1L0Re":[function(require,module,exports) {
        ...
        const response1 = await exponential_backoff_1.default(REQUEST_RETRY_WAIT, REQUEST_RETRY_NUMBER, REQUEST_RETRY_WAIT_BACKOFF, async ()=>{
            try {
                ...
                if (error.type === "TimeoutError") {
                    if (!undefined) console.warn(`Retrying request to ${method} as it has timed out`, params);
                    return null;
                }
                throw error;
            }
...
},{"buffer":"fCgem","depd":"2jGeI","./provider":"cUEh0","../utils/web":"iSqiB","../utils/errors":"btMYy","borsh":"e0LBZ","../utils/exponential-backoff":"51I5X","../utils/rpc_errors":"1TB1L"}],"2jGeI":[function(require,module,exports) {
/*!
 * depd
...
function logWarning(...args) {
    if (!undefined) console.warn(...args);
}
...
},{"buffer":"fCgem","js-sha256":"ahVaM","./utils/enums":"kjmPo","borsh":"e0LBZ","./utils/key_pair":"kBQFP"}],"ahVaM":[function(require,module,exports) {
 ...
 */ class Account {
    ...
    /** @hidden */ printLogsAndFailures(contractId, results) {
        if (!undefined) for (const result of results){
    ...
    /** @hidden */ printLogs(contractId, logs, prefix = "") {
        if (!undefined) for (const log of logs)console.log(`${prefix}Log [${contractId}]: ${log}`);
    }
    /**
...
},{"buffer":"fCgem","bn.js":"9pdNn","depd":"2jGeI","./transaction":"jJQ5a","./providers":"gtL2a","borsh":"e0LBZ","./utils/key_pair":"kBQFP","./utils/errors":"btMYy","./utils/rpc_errors":"1TB1L","./constants":"lUNnG","./utils/exponential-backoff":"51I5X"}],"lUNnG":[function(require,module,exports) {
"use strict";
var __importDefault = this && this.__importDefault || function(mod) {
    return mod && mod.__esModule ? mod : {
        "default": mod
...
},{"buffer":"fCgem","depd":"2jGeI","./account":"hxSQV","./transaction":"jJQ5a","./utils":"jOCMH","borsh":"e0LBZ"}],"7yTE6":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
const CONTRACT_NAME = "dev-1653744863635-96666637907797";
    ...
    switch(env){
        ...
        case "local":
            return {
                ...
                keyPath: `${"/Users/jorgezavala"}/.near/validator_key.json`,
...
},{}]},["elsjo","ipbJo"], "ipbJo", "parcelRequire458c")

//# sourceMappingURL=index.09af489e.js.map
